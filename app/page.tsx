...
<h3>Articoli acquistati dettagliati</h3>
  ...
  <tbody>
    {invoices
      ...
      .flatMap(i =>
        i.rows.map(r => ({
          date: i.date,
          description: r.description || r.code || 'Articolo senza nome',
          qty: r.qty,
          total: r.total
        }))
      )
...
<section className="grid">
  <div className="card" style={{padding:18}}>
    <h2>Richiami automatici</h2>

    <h3>🔴 Clienti fermi da oltre 120 giorni</h3>
    <table>
      <thead>
        <tr>
          <th>Cliente</th>
    ...
    <h3>🟡 Clienti da tenere sotto controllo</h3>
    <table>
      <thead>
        <tr>
          <th>Cliente</th>
